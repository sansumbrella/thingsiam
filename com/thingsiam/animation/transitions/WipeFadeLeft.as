package com.thingsiam.animation.transitions {
	...
	*/
	...
	public class WipeFadeLeft extends Transition {
		
		public function WipeFadeLeft( w:Number = 852, h:Number = 476, bgColor:uint = 0xFFFFFF, trans:Boolean = true ){
		...
		override protected function playTransition() : void {
			...
			endMask.x = widest.right;
			TweenLite.to( endMask, 1.0, { width:widest.width, x:widest.left, ease:Quad.easeInOut } );
			end.alpha = 0.05;
